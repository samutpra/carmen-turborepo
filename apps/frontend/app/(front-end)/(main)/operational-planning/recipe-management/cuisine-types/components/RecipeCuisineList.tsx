...
import { CuisineTypesResponse } from '@/app/(front-end)/api/operational-planning/recipe-management/cuisine-types/route';
import {
	RecipeCuisine,
	...
	useEffect(() => {
		const fetchCuisineTypes = async () => {
			try {
				...
				const data: CuisineTypesResponse = await response.json();
