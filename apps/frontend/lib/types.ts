...
const CreditNoteStatusSchema = z.enum([
	'Draft',
	'Pending',
	'Approved',
	'Rejected',
...
export type CreditNoteAttachmentType = z.infer<
	typeof CreditNoteAttachmentSchema
>;
...
export type PayloadRecoverPasswordType = Omit<
	RecoverPasswordType,
	'confirmPassword'
>;
