...
('6ba7b8b0-9dad-11d1-80b4-00c04fd430c8', 'ROLL', 'Roll', true),
...
('6ba7b8ba-9dad-11d1-80b4-00c04fd430c8', 'Main Warehouse', 'inventory', 'Main Hotel Storage', true),
('6ba7b8bb-9dad-11d1-80b4-00c04fd430c8', 'HK Store Room', 'inventory', 'Housekeeping Storage', true),
('6ba7b8bc-9dad-11d1-80b4-00c04fd430c8', 'F&B Storage', 'inventory', 'Food and Beverage Storage Area', true),
('6ba7b8bd-9dad-11d1-80b4-00c04fd430c8', 'Engineering Workshop', 'inventory', 'Engineering Tools and Parts Storage', true),
('6ba7b8be-9dad-11d1-80b4-00c04fd430c8', 'Front Office Storage', 'inventory', 'Front Office Supplies Storage', true),
('6ba7b8bf-9dad-11d1-80b4-00c04fd430c8', 'Chemical Store', 'inventory', 'Chemical and Cleaning Supplies Storage', true);

-- Insert Product Categories
INSERT INTO "TENANT_DUMMY"."tb_product_category" (id, code, name, description, is_active) VALUES
('6ba7b8c1-9dad-11d1-80b4-00c04fd430c8', 'ROOM', 'Room Supplies', 'Guest Room Related Items', true),
('6ba7b8c2-9dad-11d1-80b4-00c04fd430c8', 'F&B', 'Food and Beverage', 'F&B Related Items', true), 
('6ba7b8c3-9dad-11d1-80b4-00c04fd430c8', 'MAINT', 'Maintenance', 'Maintenance Supplies', true),
('6ba7b8c4-9dad-11d1-80b4-00c04fd430c8', 'OFF', 'Office Supplies', 'Office Related Items', true);
...
('6ba7b8c5-9dad-11d1-80b4-00c04fd430c8', 'AMENITY', 'Guest Amenities', 'In-room Guest Amenities', (SELECT id FROM "TENANT_DUMMY"."tb_product_category" WHERE code = 'ROOM'), true),
('6ba7b8c6-9dad-11d1-80b4-00c04fd430c8', 'LINEN', 'Linen Items', 'Bed and Bath Linen', (SELECT id FROM "TENANT_DUMMY"."tb_product_category" WHERE code = 'ROOM'), true),
('6ba7b8c7-9dad-11d1-80b4-00c04fd430c8', 'MINIBAR', 'Mini Bar Items', 'In-room Mini Bar Products', (SELECT id FROM "TENANT_DUMMY"."tb_product_category" WHERE code = 'F&B'), true),
('6ba7b8c8-9dad-11d1-80b4-00c04fd430c8', 'CLEANING', 'Cleaning Supplies', 'Cleaning Materials', (SELECT id FROM "TENANT_DUMMY"."tb_product_category" WHERE code = 'MAINT'), true);
...
('6ba7b8d1-9dad-11d1-80b4-00c04fd430c8', 'BATH', 'Bathroom Amenities', 'Bathroom related amenities', (SELECT id FROM "TENANT_DUMMY"."tb_product_sub_category" WHERE code = 'AMENITY'), true),
('6ba7b8d2-9dad-11d1-80b4-00c04fd430c8', 'BODY', 'Body Care', 'Body care amenities', (SELECT id FROM "TENANT_DUMMY"."tb_product_sub_category" WHERE code = 'AMENITY'), true),
('6ba7b8d3-9dad-11d1-80b4-00c04fd430c8', 'BED', 'Bedding', 'Bed related linen', (SELECT id FROM "TENANT_DUMMY"."tb_product_sub_category" WHERE code = 'LINEN'), true),
('6ba7b8d4-9dad-11d1-80b4-00c04fd430c8', 'BATH_LIN', 'Bathroom Linen', 'Bathroom related linen', (SELECT id FROM "TENANT_DUMMY"."tb_product_sub_category" WHERE code = 'LINEN'), true),
('6ba7b8d5-9dad-11d1-80b4-00c04fd430c8', 'DRINK', 'Beverages', 'Minibar drinks', (SELECT id FROM "TENANT_DUMMY"."tb_product_sub_category" WHERE code = 'MINIBAR'), true),
...
('6ba7b8d7-9dad-11d1-80b4-00c04fd430c8', 'FLOOR', 'Floor Cleaning', 'Floor cleaning supplies', (SELECT id FROM "TENANT_DUMMY"."tb_product_sub_category" WHERE code = 'CLEANING'), true),
('6ba7b8d8-9dad-11d1-80b4-00c04fd430c8', 'SURFACE', 'Surface Cleaning', 'Surface cleaning supplies', (SELECT id FROM "TENANT_DUMMY"."tb_product_sub_category" WHERE code = 'CLEANING'), true);

-- Insert Products
INSERT INTO "TENANT_DUMMY"."tb_product" (id, code, name, local_name, description, primary_unit_id, product_status_type) VALUES
('6ba7b8e1-9dad-11d1-80b4-00c04fd430c8', 'SOAP-001', 'Bath Soap', 'สบู่อาบน้ำ', 'Luxury bath soap for guest rooms', (SELECT id FROM "TENANT_DUMMY"."tb_unit" WHERE name = 'EA'), 'active'),
('6ba7b8e2-9dad-11d1-80b4-00c04fd430c8', 'SHAM-001', 'Shampoo', 'แชมพู', 'Premium hair shampoo', (SELECT id FROM "TENANT_DUMMY"."tb_unit" WHERE name = 'BTL'), 'active'),
('6ba7b8e3-9dad-11d1-80b4-00c04fd430c8', 'TOWEL-001', 'Bath Towel', 'ผ้าเช็ดตัว', 'Large bath towel', (SELECT id FROM "TENANT_DUMMY"."tb_unit" WHERE name = 'EA'), 'active'),
('6ba7b8e4-9dad-11d1-80b4-00c04fd430c8', 'TISSUE-001', 'Facial Tissue', 'กระดาษทิชชู่', 'Soft facial tissue box', (SELECT id FROM "TENANT_DUMMY"."tb_unit" WHERE name = 'BOX'), 'active'),
('6ba7b8e5-9dad-11d1-80b4-00c04fd430c8', 'WATER-001', 'Mineral Water', 'น้ำแร่', 'Premium mineral water 500ml', (SELECT id FROM "TENANT_DUMMY"."tb_unit" WHERE name = 'BTL'), 'active'),
('6ba7b8e6-9dad-11d1-80b4-00c04fd430c8', 'SNACK-001', 'Mixed Nuts', 'ถั่วรวม', 'Assorted premium nuts', (SELECT id FROM "TENANT_DUMMY"."tb_unit" WHERE name = 'EA'), 'active'),
('6ba7b8e7-9dad-11d1-80b4-00c04fd430c8', 'CLEAN-001', 'Floor Cleaner', 'น้ำยาถูพื้น', 'Multi-surface floor cleaner', (SELECT id FROM "TENANT_DUMMY"."tb_unit" WHERE name = 'BTL'), 'active'),
('6ba7b8e8-9dad-11d1-80b4-00c04fd430c8', 'SHEET-001', 'Bed Sheet', 'ผ้าปูที่นอน', 'King size bed sheet', (SELECT id FROM "TENANT_DUMMY"."tb_unit" WHERE name = 'SET'), 'active'),
('6ba7b8e9-9dad-11d1-80b4-00c04fd430c8', 'PILLOW-001', 'Pillow Case', 'ปลอกหมอน', 'Standard pillow case', (SELECT id FROM "TENANT_DUMMY"."tb_unit" WHERE name = 'EA'), 'active'),
('6ba7b8ea-9dad-11d1-80b4-00c04fd430c8', 'PAPER-001', 'Toilet Paper', 'กระดาษชำระ', 'Toilet paper roll', (SELECT id FROM "TENANT_DUMMY"."tb_unit" WHERE name = 'ROLL'), 'active');
...
('6ba7b8f1-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'SOAP-001'), (SELECT id FROM "TENANT_DUMMY"."tb_product_item_group" WHERE code = 'BATH'), false, 50.00, 'vat', 7),
('6ba7b8f2-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'SHAM-001'), (SELECT id FROM "TENANT_DUMMY"."tb_product_item_group" WHERE code = 'BATH'), false, 80.00, 'vat', 7),
('6ba7b8f3-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'TOWEL-001'), (SELECT id FROM "TENANT_DUMMY"."tb_product_item_group" WHERE code = 'BATH_LIN'), false, 250.00, 'vat', 7),
('6ba7b8f4-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'TISSUE-001'), (SELECT id FROM "TENANT_DUMMY"."tb_product_item_group" WHERE code = 'BATH'), false, 45.00, 'vat', 7),
('6ba7b8f5-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'WATER-001'), (SELECT id FROM "TENANT_DUMMY"."tb_product_item_group" WHERE code = 'DRINK'), false, 25.00, 'vat', 7),
('6ba7b8f6-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'SNACK-001'), (SELECT id FROM "TENANT_DUMMY"."tb_product_item_group" WHERE code = 'SNACK'), false, 120.00, 'vat', 7),
('6ba7b8f7-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'CLEAN-001'), (SELECT id FROM "TENANT_DUMMY"."tb_product_item_group" WHERE code = 'FLOOR'), false, 180.00, 'vat', 7),
('6ba7b8f8-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'SHEET-001'), (SELECT id FROM "TENANT_DUMMY"."tb_product_item_group" WHERE code = 'BED'), false, 850.00, 'vat', 7),
('6ba7b8f9-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'PILLOW-001'), (SELECT id FROM "TENANT_DUMMY"."tb_product_item_group" WHERE code = 'BED'), false, 350.00, 'vat', 7),
('6ba7b8fa-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'PAPER-001'), (SELECT id FROM "TENANT_DUMMY"."tb_product_item_group" WHERE code = 'BATH'), false, 35.00, 'vat', 7);

-- Insert Product Locations
INSERT INTO "TENANT_DUMMY"."tb_product_location" (id, product_id, location_id) VALUES
('6ba7b901-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'SOAP-001'), '6ba7b8ba-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b902-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'SHAM-001'), '6ba7b8ba-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b903-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'TOWEL-001'), '6ba7b8bb-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b904-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'TISSUE-001'), '6ba7b8bb-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b905-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'WATER-001'), '6ba7b8bc-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b906-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'SNACK-001'), '6ba7b8bc-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b907-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'CLEAN-001'), '6ba7b8bf-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b908-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'SHEET-001'), '6ba7b8bb-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b909-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'PILLOW-001'), '6ba7b8bb-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b90a-9dad-11d1-80b4-00c04fd430c8', (SELECT id FROM "TENANT_DUMMY"."tb_product" WHERE code = 'PAPER-001'), '6ba7b8bb-9dad-11d1-80b4-00c04fd430c8');
...
INSERT INTO "CARMEN_SYSTEM"."tb_business_unit" (id, code, name, description, is_active, cluster_id) VALUES
('6ba7b921-9dad-11d1-80b4-00c04fd430c8', 'BU-001', 'Hotel Operations', 'Main hotel operations unit', true, '6ba7b911-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b922-9dad-11d1-80b4-00c04fd430c8', 'BU-002', 'Food & Beverage', 'Restaurant and catering services', true, '6ba7b911-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b923-9dad-11d1-80b4-00c04fd430c8', 'BU-003', 'Housekeeping', 'Room maintenance and cleaning services', true, '6ba7b911-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b924-9dad-11d1-80b4-00c04fd430c8', 'BU-004', 'Spa & Wellness', 'Spa and wellness center operations', true, '6ba7b911-9dad-11d1-80b4-00c04fd430c8'),
('6ba7b925-9dad-11d1-80b4-00c04fd430c8', 'BU-005', 'Events & Conferences', 'Event planning and conference facilities', true, '6ba7b911-9dad-11d1-80b4-00c04fd430c8');
