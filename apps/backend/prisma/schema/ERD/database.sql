...
CREATE TYPE "CARMEN_SYSTEM"."SubscriptionStatus" AS ENUM (
  'Active',
  'Inactive',
  'expired'
);

CREATE TYPE "TENANT_DUMMY"."LocationType" AS ENUM (
  'Inventory',
  'Direct'
);

CREATE TYPE "TENANT_DUMMY"."UnitType" AS ENUM (
  'OrderUnit',
  'InventoryUnit',
  'RecipeUnit'
);

CREATE TYPE "TENANT_DUMMY"."PRDocStatus" AS ENUM (
  'Draft',
  'WIP',
  'Complete'
);

CREATE TYPE "TENANT_DUMMY"."PRWorkflowStatus" AS ENUM (
  'Draft',
  'Pending',
  'Review',
  'Accept'
...
CREATE TYPE "TENANT_DUMMY"."POStatus" AS ENUM (
  'Open',
  'Voided',
  'Closed',
  'Draft',
...
CREATE TYPE "TENANT_DUMMY"."InvDocType" AS ENUM (
  'GRN',
  'CN',
  'SR',
  'ISSUE',
...
CREATE TABLE "TENANT_DUMMY"."Location" (
  "id" uuid PRIMARY KEY NOT NULL DEFAULT (gen_random_uuid()),
  "name" varchar UNIQUE NOT NULL,
  "inventoryType" "TENANT_DUMMY"."LocationType" NOT NULL,
  "description" text,
  "isActive" bool DEFAULT true,
...
CREATE TABLE "TENANT_DUMMY"."Inv0" (
  "id" uuid PRIMARY KEY NOT NULL DEFAULT (gen_random_uuid()),
  "name" varchar UNIQUE NOT NULL,
  "invDocType" "TENANT_DUMMY"."InvDocType"
);
...
CREATE UNIQUE INDEX "company_code_u" ON "CARMEN_SYSTEM"."Cluster" ("code");

CREATE UNIQUE INDEX "company_name_u" ON "CARMEN_SYSTEM"."Cluster" ("name");
...
ALTER TABLE "CARMEN_SYSTEM"."Module" ADD FOREIGN KEY ("createById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."Module" ADD FOREIGN KEY ("updateById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."BusinessUnitModule" ADD FOREIGN KEY ("businessUnitId") REFERENCES "CARMEN_SYSTEM"."BusinessUnit" ("id");

ALTER TABLE "CARMEN_SYSTEM"."BusinessUnitModule" ADD FOREIGN KEY ("moduleId") REFERENCES "CARMEN_SYSTEM"."Module" ("id");

ALTER TABLE "CARMEN_SYSTEM"."BusinessUnitModule" ADD FOREIGN KEY ("createById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."BusinessUnitModule" ADD FOREIGN KEY ("updateById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."Subscription" ADD FOREIGN KEY ("clusterId") REFERENCES "CARMEN_SYSTEM"."Cluster" ("id");

ALTER TABLE "CARMEN_SYSTEM"."Subscription" ADD FOREIGN KEY ("createById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."Subscription" ADD FOREIGN KEY ("updateById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."SubscriptionDetail" ADD FOREIGN KEY ("subscriptionId") REFERENCES "CARMEN_SYSTEM"."Subscription" ("id");

ALTER TABLE "CARMEN_SYSTEM"."SubscriptionDetail" ADD FOREIGN KEY ("bussinessUnitId") REFERENCES "CARMEN_SYSTEM"."BusinessUnit" ("id");

ALTER TABLE "CARMEN_SYSTEM"."SubscriptionDetail" ADD FOREIGN KEY ("moduleId") REFERENCES "CARMEN_SYSTEM"."Module" ("id");

ALTER TABLE "CARMEN_SYSTEM"."SubscriptionDetail" ADD FOREIGN KEY ("createById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."SubscriptionDetail" ADD FOREIGN KEY ("updateById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."Cluster" ADD FOREIGN KEY ("createById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."Cluster" ADD FOREIGN KEY ("updateById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."BusinessUnit" ADD FOREIGN KEY ("clusterId") REFERENCES "CARMEN_SYSTEM"."Cluster" ("id");

ALTER TABLE "CARMEN_SYSTEM"."BusinessUnit" ADD FOREIGN KEY ("createById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."BusinessUnit" ADD FOREIGN KEY ("updateById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."UserBusinessUnit" ADD FOREIGN KEY ("userId") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."UserBusinessUnit" ADD FOREIGN KEY ("businessunitId") REFERENCES "CARMEN_SYSTEM"."BusinessUnit" ("id");

ALTER TABLE "CARMEN_SYSTEM"."UserBusinessUnit" ADD FOREIGN KEY ("createById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."UserBusinessUnit" ADD FOREIGN KEY ("updateById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."NotificationPreference" ADD FOREIGN KEY ("userId") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."NotificationPreference" ADD FOREIGN KEY ("createById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."NotificationPreference" ADD FOREIGN KEY ("updateById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."Notification" ADD FOREIGN KEY ("userId") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."Notification" ADD FOREIGN KEY ("createById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."Notification" ADD FOREIGN KEY ("updateById") REFERENCES "CARMEN_SYSTEM"."User" ("id");

ALTER TABLE "CARMEN_SYSTEM"."Role" ADD FOREIGN KEY ("bussinessUnitId") REFERENCES "CARMEN_SYSTEM"."BusinessUnit" ("id");
...
ALTER TABLE "TENANT_DUMMY"."Location" ADD FOREIGN KEY ("deliveryPointId") REFERENCES "TENANT_DUMMY"."DeliveryPoint" ("id");
...
ALTER TABLE "TENANT_DUMMY"."Product" ADD FOREIGN KEY ("primaryUnit") REFERENCES "TENANT_DUMMY"."Unit" ("id");
...
ALTER TABLE "TENANT_DUMMY"."PR0" ADD FOREIGN KEY ("prTypeId") REFERENCES "TENANT_DUMMY"."PRType" ("id");

ALTER TABLE "TENANT_DUMMY"."PR1" ADD FOREIGN KEY ("PR0Id") REFERENCES "TENANT_DUMMY"."PR0" ("id");

ALTER TABLE "TENANT_DUMMY"."PR1Workflow" ADD FOREIGN KEY ("PR1Id") REFERENCES "TENANT_DUMMY"."PR1" ("id");

ALTER TABLE "TENANT_DUMMY"."POItem" ADD FOREIGN KEY ("POId") REFERENCES "TENANT_DUMMY"."PO" ("id");
...
ALTER TABLE "TENANT_DUMMY"."Inv1" ADD FOREIGN KEY ("inv0Id") REFERENCES "TENANT_DUMMY"."Inv0" ("id");

ALTER TABLE "TENANT_DUMMY"."Inv2" ADD FOREIGN KEY ("inv1Id") REFERENCES "TENANT_DUMMY"."Inv1" ("id");

ALTER TABLE "TENANT_DUMMY"."GRN0" ADD FOREIGN KEY ("inv0Id") REFERENCES "TENANT_DUMMY"."Inv0" ("id");

ALTER TABLE "TENANT_DUMMY"."GRN1" ADD FOREIGN KEY ("GRN0Id") REFERENCES "TENANT_DUMMY"."GRN0" ("id");

ALTER TABLE "TENANT_DUMMY"."SR0" ADD FOREIGN KEY ("inv0Id") REFERENCES "TENANT_DUMMY"."Inv0" ("id");

ALTER TABLE "TENANT_DUMMY"."SR1" ADD FOREIGN KEY ("SR0Id") REFERENCES "TENANT_DUMMY"."SR0" ("id");

ALTER TABLE "TENANT_DUMMY"."SI0" ADD FOREIGN KEY ("inv0Id") REFERENCES "TENANT_DUMMY"."Inv0" ("id");

ALTER TABLE "TENANT_DUMMY"."SI1" ADD FOREIGN KEY ("SI0Id") REFERENCES "TENANT_DUMMY"."SI0" ("id");

ALTER TABLE "TENANT_DUMMY"."SO0" ADD FOREIGN KEY ("inv0Id") REFERENCES "TENANT_DUMMY"."Inv0" ("id");

ALTER TABLE "TENANT_DUMMY"."SO1" ADD FOREIGN KEY ("SO0Id") REFERENCES "TENANT_DUMMY"."SO0" ("id");
