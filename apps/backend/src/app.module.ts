...
import {
  ExchangerateModule,
} from './_application/exchangerate/exchangerate.module';
import {
  GoodReceiveNoteModule,
} from './_application/good-receive-note/good-receive-note.module';
import { LocationsModule } from './_application/locations/locations.module';
import {
  ProductCategoryModule,
} from './_application/product-category/product-category.module';
import {
  ProductItemGroupModule,
} from './_application/product-item-group/product-item-group.module';
import {
  ProductSubCategoryModule,
} from './_application/product-sub-category/product-sub-category.module';
import { ProductsModule } from './_application/products/products.module';
import {
  PurchaseOrderModule,
} from './_application/purchase-order/purchase-order.module';
import {
  PurchaseRequestModule,
} from './_application/purchase-request/purchase-request.module';
import {
  StoreRequisitionModule,
} from './_application/store-requisition/store-requisition.module';
import { UnitsModule } from './_application/units/units.module';
import {
  UserBusinessUnitModule,
} from './_application/user-business-unit/user-business-unit.module';
import {
  UserPermissionModule,
} from './_application/user-permission/user-permission.module';
import {
  VendorProductModule,
} from './_application/vendor-product/vendor-product.module';
...
import {
  SystemClusterModule,
} from './_system/system-cluster/system-cluster.module';
import {
