...
export type UnitConversionCreateModel = z.infer<typeof UnitConversionCreateSchema>;
...
export const UnitConversionUpdateSchema = z.object({
	...
	unit_type: z.enum(Object.values(enum_unit_type) as [string, ...string[]]).optional(),
...
export type UnitConversionUpdateModel = z.infer<typeof UnitConversionUpdateSchema>;
