...
const enumActivityAction = z.enum(['read', 'create', 'update', 'delete', 'login', 'other']);
...
export type globalActivityCreateModel = z.infer<typeof globalActivityCreateSchema>;
...
export type globalActivityUpdateModel = z.infer<typeof globalActivityUpdateSchema>;
