...
export type PurchaseRequestCreateModel = z.infer<typeof PurchaseRequestCreateSchema>;
...
export type PurchaseRequestUpdateModel = z.infer<typeof PurchaseRequestUpdateSchema>;
...
export type PurchaseRequestDetailCreateModel = z.infer<typeof PurchaseRequestDetailCreateSchema>;

export class PurchaseRequestDetailCreateDto implements PurchaseRequestDetailCreateModel {
	id?: string;
...
export type PurchaseRequestDetailUpdateModel = z.infer<typeof PurchaseRequestDetailUpdateSchema>;

export class PurchaseRequestDetailUpdateDto implements PurchaseRequestDetailUpdateModel {
	id!: string;
	purchase_request_id!: string;
	product_item_group_id!: string;
	quantity?: number;
