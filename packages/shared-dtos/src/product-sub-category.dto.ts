...
export type ProductSubCategoryCreateModel = z.infer<typeof ProductSubCategoryCreateSchema>;

export class ProductSubCategoryCreateDto implements ProductSubCategoryCreateModel {
	id?: string;
	code?: string;
	name!: string;
...
export type ProductSubCategoryUpdateModel = z.infer<typeof ProductSubCategoryUpdateSchema>;

export class ProductSubCategoryUpdateDto implements ProductSubCategoryUpdateModel {
	id!: string;
	code?: string;
	name!: string;
	description?: string | null;
