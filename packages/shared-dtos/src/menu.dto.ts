...
export const MenuCreateSchema = z.object({
	id: z.string().uuid(),
	name: z.string().min(1, 'name must be at least 1 character').max(5, 'name must be at most 5 characters'),
...
export const MenuUpdateSchema = z.object({
	...
	name: z.string().min(1, 'name must be at least 1 character').max(5, 'name must be at most 5 characters').optional(),
	description: z.string().optional(),
